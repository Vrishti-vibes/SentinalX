    ...
    <div className="flex flex-col min-h-full bg-[#f8fafc] text-slate-900 font-sans">
      ...
      <div className="p-4 sm:p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          {/* Left Column: ID, Alert & Location Map */}
          <div className="lg:col-span-6 space-y-4 flex flex-col justify-between">
            {/* Incident ID & Verification Status card */}
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm space-y-2.5">
            ...
            <div className="rounded-2xl border border-rose-100 bg-white overflow-hidden shadow-sm flex-1 flex flex-col">
          ...
          <div className="lg:col-span-6 space-y-4 flex flex-col justify-between">
            ...
            <div className="rounded-2xl border border-rose-100 bg-white p-4 sm:p-5 shadow-sm space-y-4 flex-1">
